...
class LinkedInPeopleProfileSpider(scrapy.Spider):
    ...
    def parse_profile(self, response):
        ...
        logging.info(f"Processing profile: {item['profile']}")
        ...
        try:
            ...
            if 'followers' in item['location'] or 'connections' in item['location']:
                item['location'] = ''
                logging.warning(f"Invalid location for profile {item['profile']}")
        ...
        for block in experience_blocks:
            ...
            try:
                ...
                logging.error(f"experience --> organisation_profile error for {item['profile']}: {e}")
        ...
        for block in education_blocks:
            ...
            try:
                ...
                logging.error(f"education --> organisation error for {item['profile']}: {e}")
